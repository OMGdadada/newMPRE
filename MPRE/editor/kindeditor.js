...
K.options = {
	...
	filterMode: false,    //	filterMode : true,
	wellFormatMode : true,
	shadowMode : true,
	loadStyleMode : true,
	basePath : K.basePath,
...
//		],
	items: [
		'source', '|', 'template', 'quickformat', 'table', 'removeformat', '|', 'undo', 'redo',  
		'|', 'justifyleft', 'justifycenter', 'justifyright',
		'justifyfull', 'lineheight', '|', 'fullscreen', '/',
		'clearhtml',  'fontname', 'fontsize', '|', 'forecolor', 'bold',
		'italic', 'underline','|', 'image',
		'flash', 'link', 'unlink', 'hr'
	],
