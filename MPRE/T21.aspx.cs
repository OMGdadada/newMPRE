...
public partial class T21 : System.Web.UI.Page
{
    ...
    private void InsertDatabase()
    {
        ...
        //调用Util中写好的函数将值插入数据库
        i = Util.InsertDatabase("T21", fields, values, fields.Count);

        if (i == 1)
        {
            if (Session["Code"] == null)
            { 
                Response.Write(" <script> alert(\"成功提交！\");;window.location='R21.aspx?TGUID=" + GUID.Text + "&TNum=21'; </script> ");
            }
            else
            {
