...
using System.Text;
public partial class T22 : System.Web.UI.Page
{
    ...
    private void InsertDatabase()
    {
        ...
        //***算分***
        decimal RawScore, D1, D2, D3, D4 = 0;
        ...
        fields.Add("DoctorGUID"); fields.Add("D1"); fields.Add("D2"); fields.Add("D3"); fields.Add("D4");
        ...
        values.Add(DoctorGUID.Text); values.Add(D1); values.Add(D2); values.Add(D3); values.Add(D4);

        //调用Util中写好的函数将值插入数据库
        i = Util.InsertDatabase("T22", fields, values, fields.Count);

        if (i == 1)
        {
            if (Session["Code"] == null)
            {
               Response.Write(" <script> alert(\"成功提交！\");;window.location='R22.aspx?TGUID=" + GUID.Text + "&TNum=22'; </script> ");
            }
            else
            {
