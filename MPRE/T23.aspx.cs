...
using System.Text;
public partial class T23 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            else
            {
                ...
                GUID.Text = strGUID;
                TestName.Text = "自知力与治疗态度问卷表（ITAQ）";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string error = "";
        for (int i = 1; i <= 11; i++)//条件：i应小于等于必做题目的总数
        {
    ...
    private void InsertDatabase()
    {
        ...
        //***算分***
        decimal RawScore, D1, D2, D3, D4, D5, D6, D7, D8, D9, D10, D11 = 0;
        ...
        fields.Add("D6"); fields.Add("D7"); fields.Add("D8"); fields.Add("D9"); fields.Add("D10"); fields.Add("D11");
        ...
        values.Add(D6); values.Add(D7); values.Add(D8); values.Add(D9); values.Add(D10); values.Add(D11);
        //调用Util中写好的函数将值插入数据库
        i = Util.InsertDatabase("T23", fields, values, fields.Count);

        if (i == 1)
        {
            if (Session["Code"] == null)
            {
                Response.Write(" <script> alert(\"成功提交！\");;window.location='R23.aspx?TGUID=" + GUID.Text + "&TNum=23'; </script> ");
            }
            else
            {
