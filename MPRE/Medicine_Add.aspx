<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="Medicine_Add.aspx.cs" Inherits="Medicine_Add" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="CurrentPosition">当前位置：<a href="Medicine_Man.aspx">药物管理</a> >> <a href="#">添加药物</a></div>
    <p>&nbsp;</p>
    <div class="row">
        <div class="col-lg-6 col-sm-6 col-xs-12">
            <div class="well with-header">
                <div class="header bordered-blue">添加药物</div>
                <h6>药物名  
                ...
                <div>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="/*药物名必填*/" ControlToValidate="TagName"></asp:RequiredFieldValidator>
                </div>
                <p>
