<%@ Page Title="" Language="C#" MasterPageFile="~/Test.master" AutoEventWireup="true" CodeFile="T12.aspx.cs" Inherits="T12" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="blanks2" id="Cover" runat="server" ></div>
                    <div  class="module-area3 modal-content" id="Cover1" runat="server" >
                      ...
                      <p>该测试表为自评量表，阅读下面9个题目，并在符合您的选项上划勾。答案无所谓正确与错误。请回答所有的问题，但不用花费大量的时间思考每个答案。每个题目您只能在三个答案中选一个（不同意、同意或非常同意）。</p>
        ...
        <div class="widget flat radius-bordered">
            ...
            <div class="widget-header bordered-bottom bordered-blue">
                <div style="text-align:left;padding-top:10px;">
                    ...
                    <p>
                  自评量表，阅读下面9个题目，并在符合您的选项上划勾。答案无所谓正确与错误。请回答所有的问题，但不用花费大量的时间思考每个答案。每个题目您只能在三个答案中选一个（不同意、同意或非常同意）。 </p>
                </div>
            </div>
            <div class="widget-body bordered-bottom bordered-darkorange">
                ...
                <table class="table" style="width: 90%">
                    ...
                    <tr>
                        ...
                        <th colspan="4">5. 我会对现在的生活感到激动或兴奋</th>
