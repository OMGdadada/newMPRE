<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="Department_Add.aspx.cs" Inherits="Department_Add" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="CurrentPosition">当前位置：<a href="Department_Man.aspx">科室管理</a> >> <a href="#">添加科室</a></div>
    <p>&nbsp;</p>
    <div class="row">
        <div class="col-lg-6 col-sm-6 col-xs-12">
            <div class="well with-header">
                <div class="header bordered-blue">添加科室</div>
                <h6>科室名  
                ...
                <div>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="/*科室名必填*/" ControlToValidate="TagName"></asp:RequiredFieldValidator>
                </div>
                <p>
