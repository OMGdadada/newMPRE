                                        ...
                                        <ul id="Ul">
                                            <li class="Li" v-for="item in list" >
                                                ...
                                                <label class="Label" :for="'q'+item.QuestionSerial+item.Serial+''">
                                                    ...
                                                    <label>{{item.ItemText}}
                                                    <label>
                                                        <textarea v-if="item.HasTextBox" style="height:15px;resize: none;"></textarea>
                                                    </label>
                                                </label>
                                            </li>
                                        </ul>
        ...
        <script>
            ...
            var vm = new Vue({
                ...
                data: {
                    ...
                    All:0,
                    list: [
                        { "QuestionText": "&lt;p&gt;123", "QuestionSerial": "1", "Score": "1", "Serial": "1", "ItemText": "是", "QuestionType": "1" },
            ...
            function ajax3(v) {
                ...
                if (ItemSerial == 0) {
                    ...
                    $.ajax({
                        ...
                        data: { "v": v, "TGUID": TGUID[1],"GUID":GUID[1],"ItemSerial":ItemSerial },
                        dataType: 'xml', //返回的类型为XML ，和前面的Json，不一样了
                        async: false,//设置为同步操作就可以给全局变量赋值成功 
                        success: function (Nums) {
                            try {
