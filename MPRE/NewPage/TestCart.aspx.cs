...
public partial class NewPage_TestCart : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        using (SqlConnection conn = new DB().GetConnection())
        {
            string sql = "Update [Code_Cart] set CreateDate = @CreateDate, Code=@Code where CartGUID = @GUID";
