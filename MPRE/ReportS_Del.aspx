<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="ReportS_Del.aspx.cs" Inherits="ReportS_Del" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="CurrentPosition">
        当前位置：<a href="ReportS_List.aspx">报告单管理</a> >> <a href="#">彻底删除总报告单</a>
    </div>
    <p>&nbsp;</p>
    <h3 style="color: red">您确定要删除以下总报告单吗？一旦删除，将不可恢复！</h3>
    <p>&nbsp;</p>
    <div>
            ...
            <div class="col-lg-15">
                <div class="widget">
                    <div class="widget-header ">
                        <span class="widget-caption">删除总报告单</span>
                    </div>
                    <!--Widget Header-->
