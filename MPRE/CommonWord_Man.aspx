<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="CommonWord_Man.aspx.cs" Inherits="CommonWord_Man" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="CurrentPosition">当前位置：<a href="CommonWord_Man.aspx">常用语管理</a></div>
                    ...
                    <div class="col-xs-12 col-md-12">
                        <div class="widget">
                            <div class="widget-header ">
                                <span class="widget-caption">常用语列表</span>
                            </div>
                            <div class="widget-body">
                                <div id="Man_Nav">
                                    <div class="form-group col-xs-3 col-md-3">
                                        <span class="input-icon">
                                            <asp:TextBox ID="SearchTB" runat="server" placeholder="查询用语" class="form-control input-sm"></asp:TextBox>
                                ...
                                <div class=" col-xs-10 col-md-10">
                                    ...
                                    <asp:Button ID="AddAr" runat="server" Text="增加常用语" class="btn btn-info" OnClick="AddAr_Click" />
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" DataKeyNames="ID" AutoGenerateColumns="false" class="table table-striped table-bordered table-hover"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:HyperLinkField DataNavigateUrlFields="ID"
                                                DataNavigateUrlFormatString="CommonWord_Edit.aspx?ID={0}" DataTextField="CommonWord"
                                                HeaderText="常用语" ItemStyle-Width="80" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" Target="_blank"></asp:HyperLinkField>
