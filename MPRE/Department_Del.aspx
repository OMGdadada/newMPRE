<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="Department_Del.aspx.cs" Inherits="Department_Del" %>
...
<asp:Label ID="IDSLabel" runat="server" Text="" Visible="false"></asp:Label>
    <div id="CurrentPosition">
        当前位置：<a href="Department_Man.aspx">科室管理</a> >> <a href="#">彻底删除科室</a>
    </div>
    <p>&nbsp;</p>
    <h3 style="color: red">您确定要删除以下科室吗？一旦删除，将不可恢复！</h3>
    <p>&nbsp;</p>
    <div>
            ...
            <div class="col-lg-15">
                <div class="widget">
                    <div class="widget-header ">
                        <span class="widget-caption">删除科室</span>
                    </div>
                    <!--Widget Header-->
