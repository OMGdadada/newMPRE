<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="Department_Man.aspx.cs" Inherits="Department_Man" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="CurrentPosition">当前位置：<a href="Department_Man.aspx">科室管理</a></div>
                    ...
                    <div class="col-xs-12 col-md-12">
                        <div class="widget">
                            <div class="widget-header ">
                                <span class="widget-caption">科室列表</span>
                            </div>
                            <div class="widget-body">
                                <div id="Man_Nav">
                                    <div class="form-group col-xs-3 col-md-3">
                                        <span class="input-icon">
                                            <asp:TextBox ID="SearchTB" runat="server" placeholder="查询科室" class="form-control input-sm"></asp:TextBox>
                                ...
                                <div class=" col-xs-10 col-md-10">
                                    ...
                                    <asp:Button ID="AddAr" runat="server" Text="增加科室" class="btn btn-info" OnClick="AddAr_Click" />
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                     
                                    <asp:Button ID="UpdateBtn" runat="server" Text="修改科室名" class="btn btn-info" OnClick="UpdateBtn_Click" />
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:Button ID="DelAr" runat="server" Text="删除科室" class="btn btn-danger" OnClick="DelAr_Click" />
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" DataKeyNames="GUID" AutoGenerateColumns="false" class="table table-striped table-bordered table-hover"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:HyperLinkField DataNavigateUrlFields="GUID"
                                                DataNavigateUrlFormatString="Department_Edit.aspx?GUID={0}" DataTextField="Department"
                                                HeaderText="科室名" ItemStyle-Width="80" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" Target="_blank"></asp:HyperLinkField>
