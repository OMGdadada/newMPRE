...
public partial class Department_Man : System.Web.UI.Page
{
    ...
    protected void UpdateBtn_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect(Server.HtmlEncode("Department_Edit.aspx?GUID=" + ids));
        }
    }
    ...
    protected void AddAr_Click(object sender, EventArgs e)
    {
        ...
        //if (!String.IsNullOrEmpty(ids))
        //{
        Response.Redirect(Server.HtmlEncode("Department_Add.aspx"));
        //}
    ...
    protected void DelAr_Click(object sender, EventArgs e)
    {
        ...
        {
            ids = ids.Substring(1);
            Response.Redirect(Server.HtmlEncode("Department_Del.aspx?IDS=" + ids));
        }
