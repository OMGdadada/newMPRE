<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="CommonWord_Del.aspx.cs" Inherits="CommonWord_Del" %>
...
<asp:Label ID="IDSLabel" runat="server" Text="" Visible="false"></asp:Label>
    <div id="CurrentPosition">
        当前位置：<a href="CommonWord_Man.aspx">常用语管理</a> >> <a href="#">彻底删除常用语</a>
    </div>
    <p>&nbsp;</p>
    <h3 style="color: red">您确定要删除以下常用语吗？一旦删除，将不可恢复！</h3>
    <p>&nbsp;</p>
    <div>
            ...
            <div class="col-lg-15">
                <div class="widget">
                    <div class="widget-header ">
                        <span class="widget-caption">删除常用语</span>
                    </div>
                    <!--Widget Header-->
