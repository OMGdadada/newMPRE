...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="CurrentPosition">当前位置：<a href="#">医生管理</a> >> <a href="User_Man.aspx">医生列表</a></div>
                    ...
                    <div class="col-xs-12 col-md-12">
                        <div class="widget">
                            <div class="widget-header ">
                                <span class="widget-caption">医生列表</span>
                            </div>
                            <div class="widget-body">
                                <div id="Man_Nav">
                                    <div class="form-group col-xs-3 col-md-3">
                                        <span class="input-icon">
                                            <asp:TextBox ID="SearchTB" runat="server" placeholder="查询医生" class="form-control input-sm"></asp:TextBox>
                                ...
                                <div class=" col-xs-10 col-md-10">
                                    ...
                                    <asp:Button ID="AddAr" runat="server" Text="增加医生" class="btn btn-info" OnClick="AddAr_Click" />
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                     
                                    <asp:Button ID="UpdateBtn" runat="server" Text="修改信息" class="btn btn-info" OnClick="UpdateBtn_Click" />
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:Button ID="DelAr" runat="server" Text="删除医生" class="btn btn-danger" OnClick="DelAr_Click" />
                                    &nbsp;&nbsp;&nbsp;&nbsp;
