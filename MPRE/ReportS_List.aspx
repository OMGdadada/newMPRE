<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="ReportS_List.aspx.cs" Inherits="ReportS_List" %>

<%@ Register Assembly="AspNetPager" Namespace="Wuqi.Webdiyer" TagPrefix="webdiyer" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div id="CurrentPosition">当前位置：<a href="Dashboard.aspx">后台首页</a>>><a href="#">总报告单列表</a> >>  </div>
         <div class="page-body">
                <div class="row">
                    <div class="col-xs-12 col-md-12">
                        <div class="widget">
                            <div class="widget-header ">
                                <span class="widget-caption">总报告单列表</span>
                            </div>
        ...
        <ContentTemplate>
                                <div id="Man_Nav">
                                    ...
                                    <asp:DropDownList ID="OrderDDL" runat="server"
                                        ...
                                        <asp:ListItem Value=" Order by CDt Desc">日期降序</asp:ListItem>
                                        <asp:ListItem Value=" Order by CDt">日期升序</asp:ListItem>                    
                                    </asp:DropDownList>
                                    &nbsp;&nbsp;
                                ...
                                <br />
                                  ...
                                  <div class=" col-xs-10 col-md-10">
                                      <asp:Button ID="DelBtn" runat="server" Text="删除总报告单" class="btn btn-danger"
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" DataKeyNames="GUID" AutoGenerateColumns="false" class="table table-striped table-bordered table-hover"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:HyperLinkField DataNavigateUrlFields="GUID"
                                                DataNavigateUrlFormatString="Report.aspx?TGUID={0}" Text="多维度总报告单"
