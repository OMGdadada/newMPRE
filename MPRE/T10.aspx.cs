...
public partial class T10 : System.Web.UI.Page
{
    ...
    private void InsertDatabase()
    {
        ...
        //***算分***
        decimal RawScore, D1, D2, D3, D4, D5, D6, D7, D8, D9, D10 = 0;
        ...
        RawScore = (D1 + D2 + D3 + D4 + D5 + D6 + D7 + D8 + D9 + D10) / 40;
        ...
        fields.Add("DoctorGUID"); fields.Add("D1"); fields.Add("D2"); fields.Add("D3"); fields.Add("D4"); fields.Add("D5"); fields.Add("D6"); fields.Add("D7"); fields.Add("D8"); fields.Add("D9"); fields.Add("D10"); 
        ...
        values.Add(DoctorGUID.Text); values.Add(D1); values.Add(D2); values.Add(D3); values.Add(D4); values.Add(D5); values.Add(D6); values.Add(D7); values.Add(D8); values.Add(D9); values.Add(D10);

        //调用Util中写好的函数将值插入数据库
        i = Util.InsertDatabase("T10", fields, values, fields.Count);

        if (i == 1)
        {
            if (Session["Code"] == null)
            {
                Response.Write(" <script> alert(\"成功提交！\");;window.location='R10.aspx?TGUID=" + GUID.Text + "&TNum=10'; </script> ");
            }
            else
            {
